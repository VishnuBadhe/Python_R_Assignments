#1. In cryptography, a Caesar cipher is a very simple encryption techniques in which each
# letter in
...
def rot_13():
    code = {'a': 'n', 'b': 'o', 'c': 'p', 'd': 'q', 'e': 'r', 'f': 's', 'g': 't', 'h': 'u', 'i': 'v', 'j': 'w', 'k': 'x',
           'l': 'y', 'm': 'z', 'n': 'a',
    ...
    input_string = input("Enter the String you want to decode: ")
    str = ""
    print()
